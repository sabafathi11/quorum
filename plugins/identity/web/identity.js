      ...
      return h('div', {},
        ctx.ui.panel('Identity', [
          ...
          h('div', { class: 'row wrap' },
            h('button', { class: 'btn sm primary', dataset: { guide: 'identity-link' }, onclick: link, title: 'M' }, 'Link', h('kbd', {}, 'M')),
            h('button', { class: 'btn sm', dataset: { guide: 'identity-assign' }, onclick: assignTo, title: 'A' }, 'Assign…'),
            h('button', { class: 'btn sm', dataset: { guide: 'identity-outside' }, onclick: outside, title: 'O' }, 'Outside'),
            h('button', { class: 'btn sm danger', dataset: { guide: 'identity-clear' }, onclick: clear, title: 'C' }, 'Clear'),
            h('button', { class: 'btn sm', onclick: split, title: 'T' }, 'Split here', h('kbd', {}, 'T'))),
          h('div', { class: 'row' },
            h('button', { class: 'btn sm grow', dataset: { guide: 'identity-next' }, onclick: () => walk(1), title: 'Shift+Space', disabled: walking },
